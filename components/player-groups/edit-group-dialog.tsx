    ...
    try {
      const response = await fetch("/api/player-groups", {
        ...
        body: JSON.stringify({
          id: group.id,
          ...formData,
          playerIds: group.playerIds, // Preserve existing players
        }),
      })
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>Edit Player Group</DialogTitle>
            <DialogDescription>
              Update the group details. Players in the group will be preserved.
            </DialogDescription>
          </DialogHeader>
